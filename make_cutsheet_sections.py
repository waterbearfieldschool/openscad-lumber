#!/usr/bin/env python3
"""Generate cutsheet_sections.svg: cut layout for the bench
(bench3.scad) across six 8-foot 2x4s, grouped into sections --
'Frame' boards first, then 'Top slats'.
...
with open("cutsheet_sections.svg", "w") as f:
    f.write("\n".join(out) + "\n")
print(f"wrote cutsheet_sections.svg ({W}x{H})")
